...
public class UsrArticleController {
	...
	public String detail(Model model, int id) {
		...
		model.addAttribute("articleRow", article);

//		if (article == null) {
//			ResultData.from("F-1", Ut.f("%d번 게시물은 존재하지 않습니다", id));
//		}
//
//		ResultData.from("S-1", Ut.f("%d번 게시물입니다.", id), "article", article);
	...
	public String doModify(Model model, HttpSession httpSession, int id) {
